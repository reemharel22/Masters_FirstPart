...
suOlsonP1Numerit = []
suOlsonTransp = [];
suOlsonP1Numerit,x1 = P1MyNumericSolution("../data/SuOlsonP1DataScatter.txt")
suOlsonTransp = GetFromFile("../data/SuOlsonTransportDataScatter.txt")
suOlsonDiff = GetFromFile("../data/SuOlsonDiffusionDataScatter.txt")
mySuOlson,x2 = SuOlsonMyNumericSolution("../data/SuOlsonDataScatter.txt")
