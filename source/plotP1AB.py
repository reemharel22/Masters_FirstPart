...
suOlsonP1MUAB,x2 = SuOlsonMyNumericSolution("../data/SuOlsonP1MUABData.txt")
...
suOlsonDiffMUB,x1 = SuOlsonMyNumericSolution("../data/SuOlsonDiffusionDiscAsymptoticData.txt");
suOlsonTransp = [];
